    ...
    >
      <div className="relative w-full flex flex-col items-center justify-center body-font px-8 md:px-20 py-12 lg:py-20 bg-bgContrast min-h-screen">
        <div className="relative text-center max-w-screen-lg mx-auto">
          ...
          <p className="text-sm md:text-base lg:text-lg text-secondary italic mb-8">
          ...
          >
            <input
              ...
              className="p-3 px-5 border rounded-2xl mb-6 font-lora text-xl bg-bg"
            />
            <button
              type="submit"
              className="p-3 px-6 bg-primary text-bg rounded-2xl hover:bg-accent font-josefin"
            >
              Wine Pairing
            </button>
          </form>
          <h2 className="pt-8 text-2xl font-bold mb-8">
            Wine Recommendations Will Appear Below
          </h2>
          {wines.length > 0 && (
            <div className="wine-results w-full flex flex-col items-center justify-center pb-8 lg:pb-12">
              <div className="w-full flex justify-center">
                <div className="wine-list grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-6">
                  {wines.map((wine, index) => (
                    <div
                      key={index}
                      className="p-4 text-xl border rounded-2xl bg-bg"
                    >
